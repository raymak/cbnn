...
% Get Parameters
[verbose,verboseI,debug,doPlot,maxFunEvals,maxIter,tolVal,tolFun,tolX,method,...
...
for i = 1:maxIter
    ...
    % Check function value condition
    if f <= tolVal
        exitflag = 1;
        msg = 'Function value below TolVal';
        break;
    end
